<template>
    <div>
        ...
        <!--1、借款人情况-->
        <div v-if="active==1">
          <el-form :model="relatedPersonnelInformationForm" label-width="100px" :rules="dataFormRules" ref="relatedPersonnelInformationForm" :size="size">
              <el-row>
                <el-col span="8">
              ...
              <el-row>
                <el-col span="8">
                  <el-form-item label="本地居住时间">
                    <el-input v-model="relatedPersonnelInformationForm.localResidenceTime" size="small" class="width150" placeholder="本地居住时间 年"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              ...
              <el-row>
                ...
                <el-col span="8">
                  <el-form-item label="在该单位工作年限">
                    <el-input v-model="relatedPersonnelInformationForm.unitWorkingYears" placeholder="在该单位工作年限 年" size="small" class="width150"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col span="8">
                  <el-form-item label="所投资或经营企业名称">
                    <el-input v-model="relatedPersonnelInformationForm.companyName" size="small" class="width150"></el-input>
                  </el-form-item>
                </el-col>
                <el-col span="8">
                  <el-form-item label="本行业和相近行业经营年限">
                    <el-input v-model="relatedPersonnelInformationForm.yearsOperation" placeholder="在该单位工作年限 年" size="small" class="width180"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
                ...
                <div v-show="maritalStatusMarriedFlag">
                  ...
                  <el-form-item label="年龄">
                    ...
                    <el-row>
                      <el-col span="8">
                        <el-form-item label="所投资或经营企业名称">
                          <el-input v-model="relatedPersonnelInformationSpouseForm.companyName" size="small" class="width150"></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col span="8">
                        <el-form-item label="本行业和相近行业经营年限">
                          <el-input v-model="relatedPersonnelInformationSpouseForm.yearsOperation" size="small" class="width180"></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                  ...
                  <div v-show="landSpouseFlag">
                    ...
                    <el-dialog :title="operationSpouseLand?'新增':'编辑'" width="60%" :visible.sync="addSpouseLandAssetDialogVisible" :close-on-click-modal="false">
                      <el-form :model="spouseAssetTypeLand" label-width="80px" :rules="dataFormRules" ref="spouseAssetTypeLand" :size="size">
                        <el-form-item label="土地证号">
          ...
          <div v-if="addRelevantPeopleFlag">
            <el-form :model="relatedPersonnelInformationForm" label-width="100px" :rules="dataFormRules" ref="relatedPersonnelInformationForm" :size="size">
              ...
              <el-row>
                ...
                <el-col span="8">
                  <el-form-item label="在该单位工作年限">
                    <el-input v-model="relatedPersonnelInformationForm.unitWorkingYears" size="small" class="width150"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                ...
                <el-col span="8">
                  <el-form-item label="本行业和相近行业经营年限">
                    <el-input v-model="relatedPersonnelInformationForm.yearsOperation" size="small" class="width180"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
        ...
        <!--3、抵押物-->
        <div v-if="active==3">
          <el-form :model="pawn" label-width="100px" :rules="dataFormRules" ref="pawn" :size="size">
        ...
        <!--4、其他相关贷款业务信息-->
        <div v-if="active==4">
          <el-form :model="loanBusinessInformation" label-width="100px" :rules="dataFormRules" ref="loanBusinessInformation" :size="size">
            <el-row>
              <el-col span="8">
            ...
            <el-dialog title="新增交易对手信息" width="60%" :visible.sync="addCounterpartyDialogVisible" :close-on-click-modal="false">
            ...
            <div>
              ...
              <el-form :model="loanBusinessInformation" label-width="100px" :rules="dataFormRules" ref="loanBusinessInformation" :size="size">
                ...
                <el-form-item label="借款人是否为我行独家信贷客户">
        ...
        <!--6、个人贷款调查报告表-->
        <div v-if="active==6">
          <el-form :model="personalLoanSurveyReport" label-width="100px" :rules="dataFormRules" ref="personalLoanSurveyReport" :size="size">
            <hr>申请借款情况
            <el-form-item label="借款人姓名">
              <el-input v-model="personalLoanSurveyReport.borrowerName" size="small" class="width180"></el-input>
            </el-form-item>
            <el-form-item label="婚姻状况">
              <el-radio-group v-model="personalLoanSurveyReport.maritalStatus" @change="personalLoanSurveyMaritalChange">
                <el-radio  v-for="(vl, index) in PersonalLoanSurveyMaritalOptions" :label="vl.VAL_CODE" :key="index">
                  {{vl.VAL_NAME}}
                </el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item label="配偶姓名" v-if="maritalStatusFlag">
              <el-input v-model="personalLoanSurveyReport.spouseName" size="small" class="width180"></el-input>
            </el-form-item>
            <el-form-item label="是否本地户籍">
              <el-radio-group v-model="personalLoanSurveyReport.whetherLocalHouseholdRegistration">
                <el-radio  v-for="(vl, index) in WhetherLocalHouseholdRegistrationOptions" :label="vl.VAL_CODE" :key="index">
                  {{vl.VAL_NAME}}
                </el-radio>
              </el-radio-group>
            </el-form-item>
            <el-row>
              <el-col span="8">
                <el-form-item label="家庭名下房产共计">
                  <el-input v-model="personalLoanSurveyReport.totalProperty" size="small" class="width180"></el-input>
                </el-form-item>
              </el-col>
              <el-col span="8">
                <el-form-item label="总计面积">
                  <el-input v-model="personalLoanSurveyReport.totalArea" size="small" class="width180"></el-input>
                </el-form-item>
              </el-col>
              <el-col span="8">
                <el-form-item label="总价值">
                  <el-input v-model="personalLoanSurveyReport.totalRalue" size="small" class="width180"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-form-item label="">
              <el-input type="textarea" v-model="personalLoanSurveyReport.totalPropertyRemark"></el-input>
            </el-form-item>
            <el-row>
              <el-col span="8">
                <el-form-item label="家庭资产">
                  <el-input v-model="personalLoanSurveyReport.familyAssets" size="small" class="width180"></el-input>万元
                </el-form-item>
              </el-col>
              <el-col span="8">
                <el-form-item label="家庭负债">
                  <el-input v-model="personalLoanSurveyReport.householdDebt" size="small" class="width180"></el-input>
                </el-form-item>
              </el-col>
              <el-col span="8">
                <el-form-item label="年家庭收入">
                  <el-input v-model="personalLoanSurveyReport.annualHouseholdIncome" size="small" class="width180"></el-input>
                </el-form-item>
              </el-col>
              <el-col span="8">
                <el-form-item label="家庭支出">
                  <el-input v-model="personalLoanSurveyReport.familyExpense" size="small" class="width180"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col span="8">
                <el-form-item label="申贷金额">
                  <el-input v-model="personalLoanSurveyReport.amountLoan" size="small" class="width180"></el-input>万元
                </el-form-item>
              </el-col>
              <el-col span="8">
                <el-form-item label="自筹资金">
                  <el-input v-model="personalLoanSurveyReport.selfFunding" size="small" class="width180"></el-input>万元
                </el-form-item>
              </el-col>
              <el-col span="8">
                <el-form-item label="借款期限">
                  <el-input v-model="personalLoanSurveyReport.borrowingPeriod" size="small" class="width180"></el-input>年
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-form-item label="借款用途">
              <el-input v-model="personalLoanSurveyReport.useLoan" size="small" class="width180"></el-input>年
            </el-form-item>
            ...
            <el-form-item label="经测算，该保证人是否具有担保能力">
              <el-radio-group v-model="personalLoanSurveyReport.calculated">
                <el-radio  v-for="(vl, index) in CalculatedOptions" :label="vl.VAL_CODE" :key="index">
                  {{vl.VAL_NAME}}
                </el-radio>
              </el-radio-group>
            </el-form-item>
        ...
        <!--7、合同信息-->
        <div v-if="active==7">
          <el-form :model="contractInformation" label-width="100px" :rules="dataFormRules" ref="contractInformation" :size="size">
            <el-row>
              <el-col span="8">
